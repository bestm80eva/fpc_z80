...
{$i fpcdefs.inc}
  ...
  interface
    ...
    const
       system_z80_optim8os_info : tsysteminfo =
          (
            system       : system_z80_optim8os;
            name         : 'Optim8 OS';
            shortname    : 'optim8os';
            flags        : [
...
{$endif Z80_SMARTLINK_SECTIONS}
            ...
            cpu          : cpu_z80; //move to cpu_z80Nxt
            unit_env     : '';
            extradefines : '';
            exeext       : '.tzx';
            defext       : '.def';
            ...
            link         : ld_int_optim8os;
            linkextern   : ld_optim8os;
            ar           : ar_sdcc_sdar;
            res          : res_none;
            dbg          : dbg_dwarf2;
            script       : script_unix;
...
{$ifdef CPUZ80}
  {$ifdef optim8os}
    set_source_info(system_z80_optim8os_info);
  {$endif optim8os}
{$endif CPUZ80}
end.
